...
<c:url value="/admin-home/book-management" var="postBookUrl">
...
<div class="row justify-content-center">
    <div class="col-sm-8">
        ...
        <form action="${postBookUrl}" class="form-horizontal" method="post" id="formEdit" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="txtDesc" class="col-sm-2">Nội dung</label>
                <div class="col-sm-10">
                <textarea class="form-control" name="pojo.brief" id="txtDesc" rows="8"
