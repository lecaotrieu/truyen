...
<c:url value="/ajax-author-edit" var="editAuthor">
    <c:param name="urlType" value="url_edit"/>
</c:url>
<c:url var="listAuthorUrl" value="/admin-home/author-management">
...
<div class="page-content">
    <div class="row">
        <div class="col-12">
            <form action="${listAuthorUrl}" method="get" id="formUrl">
                            ...
                            <div class="pull-right tableTools-container">
                                <div class="dt-buttons btn-overlap btn-group">
                                    <a flag="info"
                                       ...
                                       title="<fmt:message key='label.author.add' bundle='${lang}'/>">
                                            <span>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Danh sách tác giả</h3>

                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 400px;">
                                        <input type="text" name="pojo.authorName" class="form-control float-right"
                                               placeholder="Tìm kiếm" value="${items.pojo.authorName}">
                                ...
                                <fmt:bundle basename="ApplicationResources">
                                    <display:table id="tableList" name="items.listResult" partialList="true"
                                        ...
                                        <display:column title="<div class='custom-control custom-checkbox'>
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input name="checkList" type="checkbox" class="custom-control-input"
                                                       id="checkbox_${tableList.authorId}" value="${tableList.authorId}">
                                                <label class="custom-control-label"
                                                       for="checkbox_${tableList.authorId}"></label>
                                            </div>
                                        </display:column>
                                        <display:column property="authorName" titleKey="label.author.name"
                                        ...
                                        <display:column titleKey="label.action" class="">
                                            <c:url value="/ajax-author-edit" var="editUrl">
                                                <c:param name="urlType" value="url_edit"/>
                                                <c:param name="pojo.authorId" value="${tableList.authorId}"/>
                                            </c:url>
                                            <c:url value="/admin-home/author-management" var="deleteUrl">
                                                <c:param name="urlType" value="url_list"/>
                                                <c:param name="pojo.authorId" value="${tableList.authorId}"/>
                                            </c:url>
